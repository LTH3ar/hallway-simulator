...
class HallwaySimulator:
    ...
    def run_simulation(self):
        ...
        if not os.path.exists(json_file) or not os.path.exists(map_file) or not os.path.exists(tmp_file):
            ...
            print("event_type 0")
            os.system(f"arm64/hallway_simulator_module/sim/app {json_file} {map_file} 0")

        else:
            print("event_type 1")
            os.system(f"arm64/hallway_simulator_module/sim/app {json_file} {map_file} 1")
    ...
    def full_clean(self):
        ...
        # create placeholder in each folder
        os.system("touch data/input/.gitkeep")
        os.system("touch data/output/.gitkeep")
        os.system("touch data/timeline/.gitkeep")
        os.system("touch data/tmp/.gitkeep")
