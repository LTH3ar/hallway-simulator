...
class HallwaySimulator:
    ...
    def run_simulation(self):
        ...
        if not os.path.exists(json_file) or not os.path.exists(map_file) or not os.path.exists(tmp_file):
            ...
            print("event_type 0")
            os.system(f"hallway_simulator_module/sim/{str(self.machine_arch)}/app {json_file} {map_file} 0")

        else:
            print("event_type 1")
            os.system(f"hallway_simulator_module/sim/{str(self.machine_arch)}/app {json_file} {map_file} 1")
